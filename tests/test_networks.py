...
def test_nineteen_pipe():
    res = load("Network-Nineteen-Pipe")
...
def test_modified_nineteen_pipe():
    res = load("Network-Modified-Nineteen-Pipe")
...
def test_fourteen_pipe():
    res = load("Network-Fourteen-Pipe")
